...
module v23_seal::bf_hmac_encryption;

use v23_seal::{hmac256ctr, kdf::{hash_to_g1_with_dst, kdf}, polynomial::{interpolate_all, Polynomial}};
...
#[test_only]
public fun get_public_key(key_server: &v23_seal::key_server::KeyServer): PublicKey {
    PublicKey {
